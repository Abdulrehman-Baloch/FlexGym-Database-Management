            ...
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    if (this.role == "Gym Member")
                    {
                        ...
                        query = "INSERT INTO MemberPlanInfo (MemberUsername, WorkoutID,DietPlanID) " +
                                    "VALUES (@MemberUsername, @WorkoutID,@DietPlanID)";
                        ...
                        using (SqlCommand cmd = new SqlCommand(query, conn))
                        {
                            ...
                            cmd.Parameters.AddWithValue("@DietPlanID", DBNull.Value);
                    ...
                    {
                        query = "INSERT INTO TrainerPlanInfo (TrainerUsername, WorkoutID,DietPlanID) " +
